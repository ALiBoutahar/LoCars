                ...
                <div class="col-md-6 ">
                    <div class="">
                        ...
                        <div class="d-flex justify-content-center p-2">
                            <button type="button" data-bs-dismiss="modal" id="submitDomain" onclick="add()">Check Domains</button>
                            <input type="file" class="styled-file-input" id="file" onchange="add()"/>
                            <button class="styled-file-button" onclick="document.querySelector('.styled-file-input').click()">Import A File</button>
                        </div>
                    </div>
                </div>
