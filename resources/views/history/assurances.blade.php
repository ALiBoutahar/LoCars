                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="d-flex justify-content-around">
                                <a class="btn btn-sm btn-info" href="{{url('/show_assurance')}}">Detail</a>
                                <a class="btn btn-sm btn-success" href="{{url('/edit_assurance')}}">Modifier</a>
