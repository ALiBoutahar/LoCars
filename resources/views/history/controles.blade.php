    ...
    <div class="container-fluid pt-3 px-4">
        <div class="row g-4 d-flex justify-content-center">
            <div class="col-sm-12 col-xl-12 d-flex justify-content-between">
                <h5 class="">Controles Techniques History</h5>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="d-flex justify-content-around">
                                <a class="btn btn-sm btn-info" href="{{url('/show_controle')}}">Detail</a>
                                <a class="btn btn-sm btn-success" href="{{url('/edit_controle')}}">Modifier</a>
